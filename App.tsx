...
const AppleButton = ({ text, onClick, variant = 'primary', className = '', fullWidth = false, loading = false, icon }: any) => {
  ...
  return (
    <button 
      onClick={onClick} 
      disabled={loading}
      className={`${base} ${styles[variant as keyof typeof styles]} ${fullWidth ? 'w-full' : 'px-8'} py-4 ${className} disabled:opacity-70`}
    >
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4 bg-black/40 backdrop-blur-xl">
            <motion.div 
              ...
              className="relative w-full max-w-lg bg-white p-8 md:p-12 rounded-[40px] shadow-2xl"
            >
              <button onClick={onClose} className="absolute top-8 right-8 text-apple-dark-gray hover:text-apple-black transition-colors"><XCircle size={32} /></button>
              ...
              {!success ? (
                ...
                <div className="text-center py-6 flex flex-col items-center gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-apple-dark-gray font-medium text-lg">Thông tin của bạn đã được hệ thống ghi nhận.</p>
                  </div>
                  <div className="w-full space-y-4">
                    <p className="text-sm font-bold text-apple-blue uppercase tracking-widest">Bước cuối cùng:</p>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className={`fixed top-11 left-0 w-full z-[100] transition-all duration-500 ${scrolled ? 'translate-y-[-2px]' : ''}`}>
        <nav className={`max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between transition-all duration-500 ${scrolled ? 'glass rounded-full mt-3 border border-black/5 mx-4 md:mx-auto' : ''}`}>
      ...
      <section className="hero-gradient pt-56 md:pt-72 pb-24 md:pb-40 px-6">
        <div className="max-w-[1100px] mx-auto text-center space-y-10">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-[96px] font-black tracking-tighter text-apple-black leading-[0.95]"
          >
            ĐỪNG CHỈ DÙNG AI.<br/>
          ...
          >
            ...
            <div className="flex flex-col items-center gap-8 pt-4">
              <AppleButton text="Giữ chỗ miễn phí ngay" className="px-16 py-6 text-2xl shadow-2xl" onClick={() => setModalOpen(true)} />
      ...
      <section id="gap" className="section-padding px-6 bg-white border-t border-apple-gray">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-20 space-y-6">
            ...
            <p className="text-apple-dark-gray text-xl md:text-2xl font-bold max-w-2xl mx-auto">Khoảng cách giữa "Nỗ lực điên cuồng" và "Kết quả đột phá" chính là một hệ thống tự động.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="apple-card p-10 md:p-16 border border-red-500/10 hover:border-red-500/30">
              ...
              <ul className="space-y-8">
                {["Làm việc 12h/ngày vẫn dậm chân tại chỗ", "Tăng trưởng phụ thuộc hoàn toàn vào sức người", "Bị kẹt trong các tác vụ lặp đi lặp lại", "Không có thời gian để suy nghĩ chiến lược"].map((t, i) => (
                  <li key={i} className="flex items-start gap-5 text-apple-dark-gray font-bold text-lg">
            ...
            <div className="apple-card p-10 md:p-16 bg-[#1D1D1F] text-white shadow-2xl shadow-blue-500/10">
              <div className="flex items-center gap-5 mb-12">
                <div className="w-16 h-16 rounded-2xl bg-apple-blue flex items-center justify-center text-white font-black text-2xl">✓</div>
                <div>
                  <h3 className="text-3xl font-black leading-none">MỤC TIÊU</h3>
              ...
              <ul className="space-y-8">
                {["AI tự động hóa 80% quy trình vận hành", "Mở rộng quy mô doanh nghiệp không giới hạn", "Tập trung 100% vào sáng tạo & doanh thu", "Sở hữu cỗ máy kiếm tiền 24/7/365"].map((t, i) => (
                  <li key={i} className="flex items-start gap-5 font-bold text-lg text-white/90">
      ...
      <section id="curriculum" className="section-padding px-6 bg-apple-gray">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-24 space-y-4">
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-apple-black">LỘ TRÌNH THỰC CHIẾN.</h2>
            ...
            {CURRICULUM.map((day, idx) => (
              <div key={idx} className="bg-white rounded-[40px] p-10 md:p-16 shadow-sm flex flex-col md:flex-row gap-16 group hover:shadow-2xl transition-all duration-700">
                <div className="md:w-1/3 space-y-6">
                  <div className="inline-flex items-center gap-2 text-apple-blue font-black text-sm tracking-widest uppercase bg-apple-blue/5 px-4 py-2 rounded-full">
                    <Sparkles size={16} /> BUỔI {day.day}
                  </div>
                  <h3 className="text-4xl font-black text-apple-black leading-tight tracking-tighter">{day.title}</h3>
      ...
      <section id="speakers" className="section-padding px-6 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-24 space-y-6">
            ...
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-apple-black">DIỄN GIẢ ĐỒNG HÀNH.</h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
            {SPEAKERS.map((speaker, idx) => (
              <div key={idx} className="apple-card p-10 md:p-16 flex flex-col gap-12 border border-black/5 hover:border-apple-blue/20 transition-all">
                <div className="flex flex-col items-center text-center gap-8">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-4xl font-black text-apple-black tracking-tighter leading-none">{speaker.name}</h3>
      ...
      {/* Value Stack (Hormozi Masterpiece) */}
          ...
          <div className="bg-[#1D1D1F] rounded-[60px] text-white p-10 md:p-24 shadow-2xl relative overflow-hidden border border-white/5">
            ...
            <div className="relative z-10">
              <div className="text-center mb-20 space-y-4">
                ...
                <p className="text-apple-dark-gray text-xl font-bold uppercase tracking-widest italic">Mọi thứ bạn nhận được trong 3 buổi</p>
              </div>
              ...
              <div className="mt-24 text-center space-y-16">
                ...
                <div className="pt-10 space-y-10">
                  <AppleButton text="Đăng ký giữ chỗ & Nhận quà" fullWidth className="py-8 text-3xl shadow-blue-500/40" onClick={() => setModalOpen(true)} />
